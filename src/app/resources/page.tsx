...
const categories = [
  {
    ...
    price: '¥68 起',
    badge: '最低价',
    gradient: 'from-orange-500/8 to-amber-400/4',
  ...
  },
  {
    ...
    bar: 'bg-linear-to-r from-violet-600 to-purple-400',
    logo: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-7 w-7">
  ...
  },
  {
    ...
    price: '¥18 起',
    badge: '即买即用',
    gradient: 'from-sky-500/8 to-blue-400/4',
  ...
  },
  {
    ...
    price: '¥19.9 起',
    badge: '持续更新',
    gradient: 'from-emerald-500/8 to-teal-400/4',
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {categories.map((cat, index) => (
            ...
            >
              <Link
                href={cat.href}
                className={`group flex flex-col overflow-hidden rounded-3xl border bg-linear-to-b transition-all hover:-translate-y-1 hover:shadow-xl ${cat.border} ${cat.gradient} bg-(--surface-raised)`}
              >
                {/* Top accent bar */}
                ...
                <div className="flex flex-1 flex-col p-6">
                  ...
                  <div className="mt-6 flex items-center justify-between border-t border-black/5 pt-4">
                    ...
                    <div className={`flex h-9 w-9 items-center justify-center rounded-full transition-transform group-hover:translate-x-1 ${cat.accentBg} ${cat.accent}`}>
